// /api/ocr-prices.js — OCR de resúmenes de subasta (con CORS)
...
module.exports = async function handler(req,res){
  ...
  try{
    ...
    const sys=`Eres un extractor para resúmenes de subasta de ganado de Costa Rica. Devuelve SOLO JSON: { "rows":[ { "category":string, "perKgAvg":number, "perKgMin":number|null, "perKgMax":number|null, "date":"YYYY-MM-DD"|null, "auction":string|null } ] }`;
